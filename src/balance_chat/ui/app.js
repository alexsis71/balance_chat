...
function humanError(error) {
  const messages = {
    ...
    metadata_session_incompatible:"Сессия создана на другой версии metadata bundle. Создайте новый чат; старые данные не будут подменены автоматически.",
    turn_in_progress:"В этой сессии уже выполняется другой запрос. Дождитесь его завершения.",
