...
DB-backed Golden P0 от 2026-08-06 прошёл `8/8` без failed layers. Защищены:
...
6. сравнение потоков Сургут → Томск и Томск → Сургут за один месяц.
...
ГП ТГ Самара и ГП ТГ Казань. Они остаются вне Golden P0; атомарное сравнение
двух противоположных направлений за один месяц теперь защищено `GQ-008`.

## Проверки качества

| Уровень | Результат | Что доказывает |
|---|---:|---|
| pytest | 228/228 | Локальные component contracts на fake/stub границах |
| Golden P0 | 8/8 | Неприкосновенное DB-backed ядро продукта |
